...
in    defaults.Config
    ⫽ { AUTOCOMPLETE =
      ...
      , disclose =
          ...
          (   defaults.Disclose
            ⫽ { inventory =
                  Some { prompt = True, default = True }
              , attributes =
                  Some { prompt = True, default = False }
              , monsters_killed =
                  Some { prompt = False, default = True }
              , monsters_genocided =
                  Some { prompt = False, default = False }
              , conduct =
                  Some { prompt = False, default = False }
              , dungeon_overview =
                  Some { prompt = False, default = False }
      ...
      , sanity_check =
          Some False
      , scores =
          { own = Some True, around = Some 2, top = Some 10 }
      , showexp =
          Some False
      , showrace =
          Some False
