...
in  { AUTOCOMPLETE :
    ...
    , acoustics :
        Optional Bool
    , align :
        Optional (Enabled ./Alignment.dhall)
    , autodescribe :
        Optional Bool
    , autodig :
        Optional Bool
    ...
    , AUTOPICKUP_EXCEPTION :
        List ./AUTOPICKUP_EXCEPTION.dhall
    , autoquiver :
        Optional Bool
    , BIND :
        List ./BIND.dhall
    ...
    , mention_walls :
        Optional Bool
    , menucolors :
        List ./MenuColor.dhall
    , menustyle :
        Optional ./MenuStyle.dhall
    , menu_deselect_all :
        Optional Text
    , menu_deselect_page :
        Optional Text
    ...
    , perm_invent :
        Optional Bool
    , pettype :
        Optional ./PetType.dhall
    , pickup_burden :
        Optional ./PickupBurden.dhall
    , pickup_thrown :
        Optional Bool
    , pickup_types :
        Optional Text
    , pile_limit :
        Optional ./PileLimit.dhall
    , playmode :
        Optional ./PlayMode.dhall
    , pushweapon :
        Optional Bool
    , race :
        Optional (Enabled ./Race.dhall)
    , rest_on_space :
        Optional Bool
    , role :
        Optional (Enabled ./Role.dhall)
    , roguesymset :
        Optional ./SymSet.dhall
    , rlecomp :
        Optional Bool
    , runmode :
        Optional ./RunMode.dhall
    , safe_pet :
        Optional Bool
    , sanity_check :
        Optional Bool
    ...
    , verbose :
        Optional Bool
    , whatis_coord :
        Optional ./WhatisCoord.dhall
    , whatis_filter :
        Optional ./WhatisFilter.dhall
    , whatis_menu :
        Optional Bool
    , whatis_moveskip :
        Optional Bool
